          ...
          <div class="bg-white border border-border/50 rounded-3xl p-6 shadow-card sticky top-[140px]">
            ...
            <div class="text-center mb-6">
              ...
              <div class="flex items-center justify-center gap-2 mb-6 p-3 bg-light-bg rounded-xl">
                ...
                <span class="font-bold text-secondary">{{ companion.rating }}</span>
                <span class="text-sm text-secondary/60">({{ companion.reviews }} отзывов)</span>
              </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-3 mb-6 pb-6 border-b border-border/50">
              ...
              <div class="p-3 bg-light-bg rounded-xl text-center">
                <p class="text-lg font-bold text-secondary">{{ companion.rating }}</p>
